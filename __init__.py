...
def register():
    ...
    if thea_globals.getRemapIRKeys():
        ...
        kmi = km.keymap_items.new('thea.smart_start_ir',value='PRESS',type='F12',ctrl=False,alt=False,shift=False,oskey=False)
        
        km = bpy.context.window_manager.keyconfigs.active.keymaps['3D View Generic']    
        kmi = km.keymap_items.new('thea.start_ir',value='PRESS',type='F12',ctrl=True,alt=False,shift=False,oskey=False)        
        
        #km = bpy.context.window_manager.keyconfigs.active.keymaps['3D View Generic']    
        #kmi = km.keymap_items.new('thea.start_ir_reuse',value='PRESS',type='F12',ctrl=True,alt=False,shift=True,oskey=False)
      
        km = bpy.context.window_manager.keyconfigs.active.keymaps['3D View Generic']    
        kmi = km.keymap_items.new('thea.update_ir',value='PRESS',type='F11',ctrl=False,alt=False,shift=False,oskey=False)   
